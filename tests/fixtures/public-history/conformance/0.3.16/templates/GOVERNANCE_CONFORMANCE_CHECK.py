...
def evaluate_central(root, policy, inputs, evaluation):
    ...
    replay = profile in {"accepted_0_3_14_replay", "accepted_0_3_15_replay"}
    if profile not in {"current_candidate", "accepted_0_3_14_replay", "accepted_0_3_15_replay"}:
