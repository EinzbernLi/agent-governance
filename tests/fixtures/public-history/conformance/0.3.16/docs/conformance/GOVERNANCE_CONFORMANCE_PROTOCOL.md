...
The same policy validation checks execution placement and Codex Worker native
delegation. Local materialization defaults to Codex; remote-only work prefers
Web; higher-precedence constraints still win. Codex child use is optional and
may save quota only with a qualified child, retained parent accountability,
...
## 8. Thin launcher and future Console
