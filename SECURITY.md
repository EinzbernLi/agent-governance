...
Please do not post credentials, tokens, secrets, exploit payloads containing
...
Use this path for governance or security bugs. Ordinary feature requests belong
in the feature request form instead.

This project makes no SLA, bounty, guaranteed response-time,
production-readiness, or certification promise.
